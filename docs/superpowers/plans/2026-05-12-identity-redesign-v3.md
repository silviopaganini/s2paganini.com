...
Worked with [The Mill](https://themill.com), [Google Creative Lab](https://experiments.withgoogle.com/), [Huge](https://hugeinc.com), [Stinkdigital](https://stinkdigital.com), [UNIT9](https://www.unit9.com), [Jam3](https://www.jam3.com), [YOOX Net-a-Porter](https://www.ynap.com), [R/GA](https://rga.com), [North Kingdom](https://northkingdom.com), [Hi-ReS!](https://www.hi-res.net), and others across São Paulo, London, and New York. Former founder of [FLUUUID](https://fluuu.id), CTO of [blkbx.](https://www.apptension.com/case-studies/blkbx-case-study), Technical Director of [mgxs.co](https://mgxs.co). Find me on [LinkedIn](https://www.linkedin.com/in/silviopaganini) or [GitHub](https://github.com/silviopaganini) — or [email](mailto:silvio@fluuu.id) me.
```
