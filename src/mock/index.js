export default {
  contents: [
    {
      content:
        "# Hello\n\nMy name is Silvio Paganini and I write [code](https://github.com/silviopaganini).  \nI like science, blockchain, astronomy, cosmology, maths, snowboard, food and travelling.  \nOne day I will disappear and be a travel blogger or a snowboarder (ok, maybe not).\n\nCurrently contracting for [Huge Inc](https://www.hugeinc.com), I'm also the Founder of [FLUUUID](https://fluuu.id) and CTO/Principal Developer of [Woala](https://woala.com), curator of [codedoodl.es](http://codedoodl.es/), part of TheFWA [Judging](https://www.thefwa.com/interview/silvio-paganini/) panel and moderator of [DevCon.London](http://devcon.london). Sometimes I write articles on [Medium](https://medium.com/@silviopaganini) and blog [inspirational](http://silviopaganini.tumblr.com/) art.\n\nIn the past 17 years, I've worked for AllOfUs, Pigzbe.com, YOOX Net-a-Porter, Stinkdigital, Nexus Interactive Arts, Jam3, North Kingdom, UNIT9, Hi-ReS!, R/GA, Isobar Nowlab, Sapient Nitro, Blast Radius, Agency Republic, Bleed, GyroHSR, EURO RSCG, Publicis, JWT and Rapp Digital.\n\n[Get in touch](https://twitter.com/silviopaganini). I'm available for freelance work and art project collaboration, or just up for a good chat over coffee/beer/wine/__put-here-your-fav-drink__\n\nToo shy to get in touch? Then download my boring [Resumé](silviopaganini.pdf) or stalk my [Linkedin](https://www.linkedin.com/in/silviopaganini).\n\nLike to spam? [email](mailto:silvio@fluuu.id) me.",
      type: 'intro',
      __typename: 'Content',
    },
    {
  ...
  techStacks: [
    ...
    },
    {
      title: 'Front-end',
      stack:
        '* ES6/Babel\n* Typescript\n* React\n* Redux/Flux\n* React\n* React-native (iOS, Android, Desktop)\n* Styled-components/Fela/Design Systems\n* SASS, Less, Stylus',
      __typename: 'TechStack',
    },
    {
      title: 'Back-end',
      stack:
        '* All the things Node.js\n* Google Cloud\n* AWS Stack\n  * EC2\n  * S3\n  * API Gateway\n  * Lambda\n  * Route 53\n  * Elastic Beanstalk\n  * Codedeploy\n  * OpsWorks\n  * Cloud Formation\n  * SES',
      __typename: 'TechStack',
    },
    {
      title: 'DevOps',
  ...
  contacts: [
    {
      link: 'http://twitter.com/silviopaganini',
      icon: {
        id: 'cjvzck6f40odd0910rite86xa',
        url: 'https://media.graphcms.com/jteANubtRz1o9JJcXUm1',
        __typename: 'Asset',
      },
      __typename: 'Contact',
    },
    {
      ...
      icon: {
        ...
        url: 'https://media.graphcms.com/Ukvfx5qMQmu81aHYgNfO',
        __typename: 'Asset',
      },
      __typename: 'Contact',
    },
    {
      link: 'http://linkedin.com/in/silviopaganini',
      icon: {
        id: 'cjvzcl8ny0lg60941mk2euqxv',
        url: 'https://media.graphcms.com/pw9DEit8TkKYjifuOj9E',
        __typename: 'Asset',
      },
      __typename: 'Contact',
    },
    {
      ...
      icon: {
        ...
        url: 'https://media.graphcms.com/3RsgtSf8S3KjRsRVPomR',
        __typename: 'Asset',
      },
      __typename: 'Contact',
    },
